...
<?php include "header.php"; ?>
	<div class="container">
		<div class="left">
			...
			<?php
include("config.php");
$sql = "SELECT Post_ID,title,description,author,featured from posts where status='publish' and category='Health'order by date desc limit 10;";
$result = $db->query($sql);
