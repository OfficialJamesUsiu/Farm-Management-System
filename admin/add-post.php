...
<a class="active" href="../index.php">Go to Blog</a>
  ...
  <input type="radio" name="category" value="Health"> Diseases<br>
  <input type="radio" name="category" value="Sports"> Growth<br>
   <input type="radio" name="category" value="Entertainment"> Loans<br>
  <input type="radio" name="category" value="Travel"> Yields<br>
